        ...
        issues: [
            {
                ...
                editorialNote:
                    'The inaugural issue of IJACR features a curated selection of research spanning multi-modal learning, privacy-preserving federated systems, edge AI, and the state of explainable AI in 2026.',
                articles: [
                    { id: 1, title: 'Editorial: Welcome to the International Journal of AI & Computing Research', authors: 'Dr. Sarah Mitchell (Editor-in-Chief)', pages: 'i–iv', doi: '10.xxxxx/ijacr.2026.01.000', category: 'Editorial', openAccess: true },
                    { id: 2, title: 'Transformer-Based Architectures for Multi-Modal Learning: A Comprehensive Survey', authors: 'J. Chen, A. Kumar, M. Rodriguez', pages: '1–28', doi: '10.xxxxx/ijacr.2026.01.001', category: 'Deep Learning', openAccess: true },
                    { id: 3, title: 'Federated Learning with Differential Privacy Guarantees for Healthcare Applications', authors: 'S. Patel, L. Wang, R. Müller', pages: '29–48', doi: '10.xxxxx/ijacr.2026.01.002', category: 'AI for Healthcare', openAccess: true },
                    { id: 4, title: 'Energy-Efficient Edge AI: Compiler Optimizations for Neural Network Inference on IoT Devices', authors: 'K. Nakamura, F. Silva, D. Kim', pages: '49–67', doi: '10.xxxxx/ijacr.2026.01.003', category: 'Edge AI', openAccess: true },
                    { id: 5, title: 'Causal Reasoning in Large Language Models: Benchmarks, Methods, and Open Challenges', authors: 'P. Gupta, E. Thompson, Y. Zhang', pages: '68–89', doi: '10.xxxxx/ijacr.2026.01.004', category: 'Generative AI', openAccess: true },
                    { id: 6, title: 'State of Explainable AI: A 2026 Survey', authors: 'Fei-Fei Li, Yoshua Bengio', pages: '90–125', doi: '10.xxxxx/ijacr.2026.01.005', category: 'Review Article', openAccess: true },
                    { id: 7, title: 'A Note on Reproducibility in Reinforcement Learning', authors: 'David Silver', pages: '126–132', doi: '10.xxxxx/ijacr.2026.01.006', category: 'Short Communication', openAccess: true },
                    { id: 8, title: 'Explainable AI for Autonomous Driving: Integrating Visual Saliency with Decision Rationale', authors: 'T. Anderson, H. Liu, C. Fernandez', pages: '133–155', doi: '10.xxxxx/ijacr.2026.01.007', category: 'AI Ethics', openAccess: true },
                ],
            },
            {
                number: 2,
